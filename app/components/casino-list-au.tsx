...
export default async function Component() {
  ...
  const picks = "1276,1304,1315,1314,1375,1340,1353,1346,62";
  ...
  const casinos = [
    ...
    },
    {
      ...
      description:
        "A Big Candy is the treat you want, with an established brand with many available currencies (both crypto and fiat) and a wide selection of games.",
    },
    {
      ...
      benefits: ["MEGA Bonuses", "RTG Games", "Customer support 24/7"],
      description:
        "Heaps-O-Wins starts with Heaps of Bonus with 320% + 50 FREE SPINS. Claim you welcome bonuses and get in on the game today at Heaps-O-Wins",
    },
    {
      ...
      description:
        "Get ready to explore a handpicked selection of games that cater to your unique gaming interests. Mega Medusa delivers large staring bonuses of 251% + 55 Free Spins to get rolling.",
    },
    {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="bg-amber-50 dark:bg-gray-800 border-2 mb-2 border-amber-400 dark:border-amber-600 shadow-md rounded-lg overflow-hidden">
        <h1 className="text-3xl font-bold mb-6 text-center dark:text-white">
          Top Australian {currentMonth} Casinos
        </h1>
        <p className="text-xl p-4 text-center dark:text-gray-200">
          Delivering the top casinos for Australian players, we believe that you
